...
## 📊 Variables / Constants
- [ ] Global constants: `path, DatabaseManager, db, guestResult, schemaResult, mockUserId, mockPlayerName, userResult, mockPlayerUUID, statsResult`
