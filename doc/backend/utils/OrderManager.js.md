...
## 📊 Variables / Constants
- [ ] Global constants: `DatabaseManager, logger, updates, results, tempUpdates, tempResults, tempErrors, finalUpdates, finalResults, finalErrors, questionOrder, answerOrder, sorted, i`
