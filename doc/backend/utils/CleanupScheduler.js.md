...
## 📊 Variables / Constants
- [ ] Global constants: `cleanupConfig, isDevelopment, intervalMs, statsBefore, result, statsAfter, io, game, timeoutMinutes, remaining, firstWarningAt, finalWarningAt, warningType, warningKey, message, warningData, beforeMap, afterMap, categories, beforeCount, afterCount, deleted`
