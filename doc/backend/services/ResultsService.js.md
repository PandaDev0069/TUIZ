...
## 📊 Variables / Constants
- [ ] Global constants: `logger, results, playersWithIds, resultPromises, finalRank, tiedRanks, accuracy, resultData, resultOutcomes, gamesPlayed, totalScore, averageScore, bestRank, averageRank, totalQuestionsAnswered, totalQuestionsCorrect, averageAccuracy, bestStreak, playerStats`
