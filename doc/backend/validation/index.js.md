...
## 📊 Variables / Constants
- [ ] Global constants: `logger, validators, errorMessage, gameValidators, validStatuses, now, oneYearAgo, oneYearFromNow, schemas, allowedActions, schema`
