...
- [ ] Internal modules:
  ...
  - `../sessionRestoreHandlers` – purpose
- [ ] Side-effects? (Y/N)
...
## 📊 Variables / Constants
- [ ] Global constants: `logger, SessionRestoreHandlers, sessionRestoreHandlers, hostSessionData, playerSessionData, gameCode, activeGame, connectedPlayers, playerData`
