...
## 🔧 Functions / Classes
### `updateActiveGameSettings(params)`
- **Purpose:**  
...
## 📊 Variables / Constants
- [ ] Global constants: `express, router, DatabaseManager, AuthMiddleware, SecurityUtils, roomManager, activeGameUpdater, logger, db, success, DEFAULT_SETTINGS, userSupabase, rawSettings, flattenedSettings, cleanSettings, validatedSettings, maxPlayers, explanationTime, currentSettings, updatedPlaySettings, roomResult, mergedRoomSettings, roomInfo, updateData, result`
