...
## 📊 Variables / Constants
- [ ] Global constants: `jwt, logger, isDevelopment, isLocalhost, supabaseUrl, supabaseServiceKey, supabaseJwtSecret, supabaseAdmin, tokenCache, CACHE_DURATION, cacheKey, cached, result, decoded, fallbackResult, authHeader, token, isExpiredToken, isInvalidToken, attempts, MAX_ATTEMPTS, WINDOW_MS, ip, now, userAttempts, timeLeft, originalEnd, client`
