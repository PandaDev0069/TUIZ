...
## 📊 Variables / Constants
- [ ] Global constants: `path, crypto, logger, sanitized, baseName, ext, randomId, timestamp, safeUserId, safeFilename, safeFolder, absolutePath, baseDir, trimmedKey, isDevelopment, isLocalhost, safeMessage, safeData, logEntry, normalizedPath, allowedBaseDirs, isAllowed, normalizedBase, allowedExtensions, dangerousPatterns, pattern`
