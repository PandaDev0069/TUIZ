...
## 📊 Variables / Constants
- [ ] Global constants: `express, router, RoomManager, logger, room, pausedAt, resumedAt, pausedDuration, sessionPausedTime, countdownValue, countdownInterval, currentQuestion, nextQuestion, skippedQuestions, stoppedAt, sessionData, finalLeaderboard, currentTimer, newRemaining, adjustmentRecord, duration`
