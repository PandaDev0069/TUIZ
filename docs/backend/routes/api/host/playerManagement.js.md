...
## 📊 Variables / Constants
- [ ] Global constants: `express, router, RoomManager, logger, room, player, kickedAt, kickRecord, socket, MIN_DURATION, MAX_DURATION, parsedDuration, mutedAt, unmuteAt, muteRecord, unmutedAt, newHost, transferredAt, currentHostId, activePlayers, mutedPlayers, kickedPlayers`
