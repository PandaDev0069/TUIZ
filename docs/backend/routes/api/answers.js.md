...
## 📊 Variables / Constants
- [ ] Global constants: `express, router, multer, DatabaseManager, AuthMiddleware, db, OrderManager, logger, orderManager, storage, upload, userSupabase, updateData, authenticatedUser, answersToInsert, userId, fileExtension, fileName, filePath, urlParts, bucketIndex, existingIds, allValid, success`
