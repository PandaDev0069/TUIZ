...
## 📊 Variables / Constants
- [ ] Global constants: `express, router, multer, path, DatabaseManager, AuthMiddleware, SecurityUtils, logger, db, storage, upload, allowedTypes, result, defaultQuestionSet, userSupabase, file, fileExt, fileName, filePath, thumbnailUrl, url, pathSegments, questionSetData, updateData`
