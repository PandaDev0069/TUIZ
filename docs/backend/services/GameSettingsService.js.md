...
## 📊 Variables / Constants
- [ ] Global constants: `gameConfig, logger, isDevelopment, defaults, fallbackDefaults, finalDefaults, gameSettings, enhancedQuestions, gameFlowConfig, parsed, timeLimit, points, hasExplanation, showExplanation, the, num`
