...
## 📊 Variables / Constants
- [ ] Global constants: `logger, isDevelopment, isLocalhost, activeGame, gameStatus, gameFromDb, connectedPlayers, gameState, gameCode, gameId, currentPlayers, lobbyState, results, existingPlayer, roomCode, playerState, remainingExplanationTime, explanationWithTimer, leaderboardWithTimer, currentQuestion, playerAnswer, playerFound, newPlayer`
