...
CREATE TABLE public.games (
  ...
  players_cap integer DEFAULT 50 CHECK (players_cap > 0),
  ...
  player_cap integer DEFAULT 50 CHECK (player_cap > 0),
...
CREATE TABLE public.question_sets (
  ...
  average_score numeric DEFAULT 0.0 CHECK (average_score >= 0::numeric),
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
